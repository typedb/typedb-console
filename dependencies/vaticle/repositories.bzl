...
def vaticle_typedb_client_java():
    git_repository(
        ...
        commit = "3710a5768b5aeecfc007fa0f200e8969d259cc15",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_client_java
    )
